        ...
        <div id="container">
          <div id="inputSpace">
            <div id="inputSelectionSpace">
              ...
              <div className="selections">
                <select
                  value={this.state.unitTestType}
                  onChange={this.handleUnitTestTypeSelectionChange}
                  id="selectedUnitTestType"
                >
...
>>>>>>> 41b168642f05c61d99b676bea017ff8e5dba166b
          ...
          <div id="outputSpace">
            <div id="outputMenu">
              <button className="outputBtn" onClick={this.testCasesBtn}>
                Test Cases
              </button>
              <button className="outputBtn" onClick={this.summaryBtn}>
                Performance
              </button>
              <button className="outputBtn" onClick={this.recommendationsBtn}>
                Recommendations
              </button>
            </div>
            <div className="output-space" id="output-space-accuracy">
              ...
              <div className="output-space" id="output-space-accuracy">
                ...
                <div id="containerTest">
                  <p>Expected Value</p>
                  <div class="resValue">{expectedValue}</div>
                  <p>Actual Value</p>
                  <div class="resValue">{actualValue}</div>
                  <p>Result</p>
                  <div class="resValue">{result}</div>
                </div>
              </div>
            </div>
          </div>
